...
const deliveryOptions = [
    {
        icon: Clock,
        title: "LIVRAISON COURSIER EXPRESS",
        desc: "Livraison rapide directe à votre domicile ou sur votre lieu de travail.",
    ...
    {
        icon: Truck,
        title: "EXPÉDITIONS RÉGIONALES",
        desc: "Envoi soigné et sécurisé vers toutes les villes via nos partenaires transporteurs.",
    ...
    {
        icon: Store,
        title: "RETRAIT GRATUIT EN BOUTIQUE",
        desc: "Venez essayer votre paire et récupérer votre commande directement au magasin.",
        badge: "100% GRATUIT",
        color: "bg-white",
        href: "/contact",
    },
